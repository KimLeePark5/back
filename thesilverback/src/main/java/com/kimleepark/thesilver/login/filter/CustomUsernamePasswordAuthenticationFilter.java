...
public class CustomUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private static final String USERNAME = "employeeNumber";
    private static final String PASSWORD = "employeePassword";

    private final ObjectMapper objectMapper;


    public CustomUsernamePasswordAuthenticationFilter(ObjectMapper objectMapper) {
        /* POST "/login" 요청이 올 때 해당 필터가 동작하도록 설정 */
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        String employeeNumber = bodyMap.get(USERNAME);
        String employeePassword = bodyMap.get(PASSWORD);

        // 인증 토큰에 세팅
        UsernamePasswordAuthenticationToken authenticationToken
                = new UsernamePasswordAuthenticationToken(employeeNumber, employeePassword);
